...
final class LanguageProvider implements AutocompleteProviderInterface, ChipProviderInterface
{
    public function __construct(private readonly RequestStack $requestStack) {}

    public function getName(): string
    {
        return 'symfony_languages';
    }
    ...
    public function search(string $query, int $limit, array $selected): array
    {
        ...
        $all = Languages::getNames($this->getLocale());
